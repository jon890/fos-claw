...
┌─────────────────────────────────────────────────────────────┐
│ 진입점 (dispatcher)                                          │
│   skills/command-router/scripts/run_now.sh                  │
│   - 14개 case 분기 (plan005 분해 이후, ADR-017)              │
...
│
├── skills/                                ← Claude Skills 표준 구조 (plan005 분해, ADR-017)
│   ├── command-router/
│   │   ├── SKILL.md
│   │   └── scripts/{run_now.sh, notify_discord.sh, setup_env.sh}
...
│   │   ├── SKILL.md
│   │   └── scripts/
│   │       ├── run_topic_recommendation.sh
│   │       ├── run_live_coding_dispatch.sh   (구 run_morning_live_coding.sh, 회사명·시점명 제거)
...
│   ├── study-pack-batch/
│   │   ├── SKILL.md
│   │   └── scripts/run_bootcamp_batch.sh     (구 run_cj_foodville_bootcamp.sh, 회사명 제거)
│   ├── study-pack-writer/
...
│   │   └── scripts/{run_question_bank.sh, run_question_bank_auto.sh (구 run_morning_question_bank.sh),
