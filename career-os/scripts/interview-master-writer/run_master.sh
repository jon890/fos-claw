...
EXTRACTOR="$TASK_ROOT/scripts/_lib/extract_and_validate_study_pack.ts"
...
extract_and_validate() {
  "$EXTRACTOR" "$RAW_RESULT_JSON" "$OUTPUT_MD"
}
...
echo "Committed and pushed: interview-master ${BASENAME} (${COMMIT_HASH})"
